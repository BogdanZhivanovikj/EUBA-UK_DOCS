...
Figure 3: Monopol – Strata $((P - ATC)\cdot Q^* < 0)$
	...
	\begin{enumerate}[a.]
		\item 
		Alternatívne náklady (alebo náklady obetovanej príležitosti) predstavujú hodnotu najlepšej možnej alternatívy, ktorej ste sa museli vzdať tým, že ste si vybrali inú možnosť 
		Napríklad, ak by ste v tom čase mohli zarobiť 20 € prácou, ale namiesto toho ste sa rozhodli pozerať televízor, vaším nákladom obetovanej príležitosti je týchto 20 €. 
		\vspace*{0.2cm}
		\item 
		Ak sa rozhodnete večer venovať štúdiu mikroekonómie pred zajtrajším testom, náklady obetovanej príležitosti predstavujú hodnotu tej najlepšej alternatívy, ktorú ste týmto výberom museli vzdať – napríklad ísť do kina, pracovať na brigáde alebo tráviť čas s rodinou.
		\vspace*{0.3cm}
		\item 
		Ak dnešný večer strávite s priateľmi vo vysokoškolskom klube, nákladom obetovanej príležitosti je hodnota tej najlepšej alternatívy, ktorej sa tak vzdáte. Podľa \href{https://sk.wikipedia.org/wiki/Alternat%C3%ADvne_n%C3%A1klady}{Wikipédie} sú náklady obetovanej príležitosti hodnotou statkov alebo aktivít, ktoré ste mohli získať alebo zažiť, ak by ste si vybrali inú možnosť.
		
		Napríklad: Ak by ste namiesto klubu mohli využiť čas na prípravu na skúšku a získať lepšiu známku, práve tento potenciálny prínos (lepšie výsledky, nové vedomosti, vyššia šanca na úspech v škole) predstavuje vaše náklady obetovanej príležitosti. Rozhodovanie pre spoločenský večer teda znamená, že ste sa dobrovoľne vzdali úžitku a možných výhod, ktoré by prinieslo intenzívne štúdium.
		\vspace*{0.3cm}
		\item 
		Ak sa rozhodnete ísť večer pred zajtrajším testom do posilňovne, oportunitné náklady predstavujú hodnotu najlepšej alternatívy, ktorej ste sa museli vzdať, keď ste sa týmto rozhodnutím rozhodli – napríklad ísť do kina, pracovať na čiastočný úväzok, študovať mikroekonómiu alebo tráviť čas s rodinou.
	\end{enumerate}
	\newpage
...
\newpage
	...
	\begin{thebibliography}{9}
		...
		\bibitem{Wikipedia -Alternatívne náklady}
		\href{https://sk.wikipedia.org/wiki/Alternat%C3%ADvne_n%C3%A1klady}{Wikipedia - Alternatívne náklady}
...
Tento dokument bol napísaný pomocou systému na prípravu dokumentov  \href{https://www.latex-project.org}{LaTeX}.

Celý zdrojový kód LaTeX je k dispozícii na GitHub ako dôkaz práce: /
\end{minipage}
\end{document}
